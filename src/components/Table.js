                                        ...
                                        return (
                                            <tr key={data.id} className='text-center border-b border-gray-100 hover:bg-gray-200 last:border-b-0'>
                                                ...
                                                <td className="py-4 flex items-center uppercase">
                                                    ...
                                                    <img className='w-[3.2rem] h-[3.2rem] mx-1.5' src={data.image} alt={data.name} />
                                                ...
                                                <td className={data.market_cap_change_percentage_24h>0 ? 'py-4 text-green' : 'text-red'}>{Number(data.market_cap_change_percentage_24h).toFixed(2)}%</td>
                                                <td className={data.price_change_percentage_1h_in_currency>0 ? 'py-4 text-green' : 'text-red'}>{Number(data.price_change_percentage_1h_in_currency).toFixed(2)}%</td>
                                                <td className={data.price_change_percentage_24h_in_currency>0 ? 'py-4 text-green' : 'text-red'}>{Number(data.price_change_percentage_24h_in_currency).toFixed(2)}%</td>
                                                <td className={data.price_change_percentage_7d_in_currency>0 ? 'py-4 text-green' : 'text-red'}>{Number(data.price_change_percentage_7d_in_currency).toFixed(2)}%</td>
                                            </tr>
                                        )
                                    })
                                }
